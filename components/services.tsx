...
const services = [
  ...
  },
  {
    ...
    image: "/images/colheitacampoaberto.webp", // Voltei a imagem do campo aqui (Maquinários)
  ...
  },
  {
    ...
    image: "/images/transporteequipa.webp", // CORRIGIDO: Imagem 'Equipa' aqui (Peças)
  ...
  },
  {
    ...
    image: "/images/colheitaalgodao.webp", // Algodão (Grãos)
